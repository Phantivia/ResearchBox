...
export function ApprovalSheet() {
  ...
  return (
    <div
      ...
      className={[
        "absolute bottom-full left-0 right-0 z-40 overflow-hidden border border-b-0 border-[var(--rb-border)] shadow-[0_-8px_24px_rgba(0,0,0,0.08)] transition-all duration-240 ease-[cubic-bezier(0.32,0.72,0,1)]",
      ...
      >
        <div className="flex flex-wrap items-start justify-between gap-2 px-4 py-3">
          <div className="min-w-0 flex-1">
            ...
            <p className="mt-0.5 font-mono text-sm text-[var(--rb-text-primary)]">{pending.tool}</p>
          </div>
          <span
...
export { ApprovalSheet as ApprovalDialog };
