...
export function FeatureIcon({ id, className = "h-4 w-4" }: FeatureIconProps) {
  switch (id) {
    case "chat-box":
      return <ChatBoxIcon className={className} />;
    case "chat-box-new":
      return <PlusIcon className={className} />;
    case "chat-box-artifacts":
      return <ChatBoxArtifactsIcon className={className} />;
    case "paper-box":
...
function ChatBoxIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
function ChatBoxArtifactsIcon({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
